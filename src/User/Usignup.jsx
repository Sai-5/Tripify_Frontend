  ...
  return (
    <div>
      <div className="flex items-center justify-center min-h-screen bg-white">
        ...
        <div
          className="relative  bg-green-400 p-8 rounded-md shadow-md overflow-hidden"
          style={{ display: "flex", height: "440px", width: "620px" }}
        >
          <div>
            <img
              ...
              style={{ marginRight: "35px", height: "380px", width: "270px" }}
            />
          </div>
